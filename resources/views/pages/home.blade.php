                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="post-entry lg">
                                <a href="blog-details.html"><img
                                        src="{{ asset('') }}assets/img/post-landscape-1.jpg" alt=""
                                        class="img-fluid"></a>
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{ asset('') }}assets/img/person-1.jpg"
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-lg-flex post-entry">
                            <a href="blog-details.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                                <img src="{{ asset('') }}assets/img/post-landscape-6.jpg" alt=""
                                    class="img-fluid">
                            </a>
                            <div>
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-list">
                                    <a href="blog-details.html"><img
                                            src="{{ asset('') }}assets/img/post-landscape-6.jpg" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span
                                            class="mx-1">•</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="blog-details.html">Let’s Get Back to Work, New York</a></h2>
